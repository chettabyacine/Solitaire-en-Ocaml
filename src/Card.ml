...
let same_color c1 c2  = match (snd c1) with
|Trefle -> ((snd c2)=Trefle) || ((snd c2) =Pique)
|Pique -> ((snd c2)=Trefle) || ((snd c2) =Pique)
|Coeur -> ((snd c2)=Coeur) || ((snd c2)=Carreau)
|Carreau -> ((snd c2)=Coeur) || ((snd c2)=Carreau)
